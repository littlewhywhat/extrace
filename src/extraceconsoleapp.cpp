...
bool ExtraceConsoleApp::admits(const Arguments & arguments) const
{
  if (!arguments.is_enabled(HELP_OPTION_NAME)
       || arguments.is_enabled(LIST_CATEGORIES_OPTION_NAME)
       || arguments.has_string(KERNEL_CATEG_FILE_OPTION_NAME)
       || arguments.hasStringList(KERNEL_CATEG_OPTION_NAME)
       || arguments.hasStringList(ANDROID_CATEG_OPTION_NAME)
       || arguments.hasStringList(APPS_OPTION_NAME)
       || arguments.hasStringList(KERNEL_FUNC_OPTION_NAME)) {
...
{
  arguments.has_string(KERNEL_CATEG_OPTION_NAME);
}
