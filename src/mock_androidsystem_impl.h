...
#ifndef LTTLWHWHT_MOCK_ANDROIDSYSTEM_IMPL_H
#define LTTLWHWHT_MOCK_ANDROIDSYSTEM_IMPL_H
...
class MockAndroidSystemImpl : public AndroidSystemImpl {
  public:
    ...
    MOCK_METHOD3(add_category, void(const char *, const char *, uint64_t));
};

#endif // LTTLWHWHT_MOCK_ANDROIDSYSTEM_IMPL_H